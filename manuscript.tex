...
Although much is known about how the long-term average $N_e$ affects linked selection, less is understood about the immediate effects of more recent changes in $N_e$ on patterns of linked selection.
...
Maize is a species of tremendous importance worldwide as both a model species \cite{strable2009} and a staple crop \cite{shiferaw2011}. \mbh{not sure we need the previous sentence}
...
We leverage the maize-teosinte study system to study these effects by first estimating the parameters of the maize domestication bottleneck using whole-genome resequencing data and then investigating the relative importance of different forms of linked selection on diversity in the recent and ancient past. 
