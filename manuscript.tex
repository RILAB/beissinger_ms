...
domestication process \mbh{I think this is referring specifically to demography (i.e., not selection during domestication)...might want to say that more clearly to distinguish this objective from objective 1} has had on genetic variability in maize, and how
...
Indeed, many adaptive traits in both maize \cite and teosinte \cite are highly quantitative \jri{cite wallace for maize? weber and/or lauter for teosinte?} and adaptation in both maize \cite{hufford2012} and teosinte \cite{pyhajarvi2013complex} has involved selection on regulatory variation.  \jri{what \% of the windows of top H12 score genome-wide occur outside of genes? is that a number to include here?}
...
Both alternative approaches we employ estimate much a larger modern effective size of maize in the range of $\approx 10^6 - 10^9$, an order of magnitude or more than the current size of teosinte.
