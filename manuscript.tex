...
%\jri{main points are there. tempted to split into two paragraphs. 1) selection/drift not independent because of linked selection. very briefly explain it -- bgs vs purifying vs hard/soft. linked selection impacted by Ne. BGS models, hard sweep models, standing variaton (hermisson/pennings petrov/messer) etc. 2) but always assume long-term Ne. pops have gone through demography, this has potential to impact both selection and drift}
