...
To quantify the interplay between drift and selection, we investigated patterns of linked selection in in the genomes of 23 domesticated maize and 13 wild teosinte individuals. 
We show that maize went through a domestication bottleneck with a population size of approximately 5\% that of teosinte before it experienced rapid population size expansion post-domestication. 
We observe that hard sweeps on genic mutations are not the primary force driving maize evolution, and that a reduced population size during domestication decreased the efficiency of purifying selection to purge deleterious alleles from maize. 
We find that expansion after domestication has increased the efficiency of purifying selection to levels exceeding those seen in teosinte. 
Our results demonstrate that demographic and selective history in the ancient and recent past both contribute to the levels of genetic variability that present today. 
Our results also show that for bottlenecked species, rapid post-bottleneck expansion can have wide-ranging impacts on diversity that conflict with the expected loss of diversity that occurs during the bottleneck itself. \jri{the whole abstract still needs work. other bottlenecked species? not very exciting. i think we need to add in the motivation rather than just "to quantify". explain that everyone else looks at long-term Ne when discussing linked selection.}
...
While larger long-term $N_e$ likely explains some of this difference, we see little change in the importance of hard sweeps in genes in singleton diversity in modern maize (Figure \ref{sFig:singleton}, suggesting other factors may contribute to these differences.  
Another possibility is that, if mutational target size scales with genome size, the larger genomes of human and maize may offer more opportunities for noncoding loci to contribute to adaptation, with hard sweeps on nonsynonymous variants then playing a relatively smaller role. 
Support from this idea comes from numerous cases of adaptive transposable element insertion modifying gene regulation \cite{studer2011,castelletti2014mite,mao2015,yang2013} and studies of local adaptation that show enrichment for SNPs in regulatory regions in teosinte \citep{pyhajarvi2013} and humans \citep{fraser2013gene} but for nonsynonymous variants in the small \emph{Arabidopsis} genome.
...
The efficiency of purifying selection is proportional to the effective population size \cite{kimura1984}, and these results are thus consistent with a demestication bottleneck and smaller long-term $N_e$ in maize \cite{eyre1998, tenaillon2004, wright2005, ross2009} and our demographic analyses showing rapid expansion and a much larger modern $N_e.  
...
Recent population bottlenecks and expansions have increased the relative abundance of 
deleterious variants in domesticated plants \cite{Gunther:2010gt,renaut2015} and human populations out of Africa \jri{is keinan2012 appropriate here? others?}, and such variants have been shown to play an important role in phenotypic variation \cite{Mezmouk:2014es} \jri{need some human cites here}. 
...
%We propose that this observation could also result from more efficient selection against such mutations. This proposition is in agreement not only with our maize observations, but also with the results of \cite{}, who showed via simulations that the increased efficiency of selection in a larger population can partially offset the increase in the total number of segregating deleterious variants.
%While the large numbers of rare variants present in expanding populations may contribute significantly to the genetic basis of complex disease \cite{keinan2012}, recent analyses suggest that 
%. However, more efficient purifying selection in larger populations, which we show operates specifically on these rare variants, should decrease genetic load by purging rare deleterious variants. 
