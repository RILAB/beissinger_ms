...
Future comparative analyses using a common statistical framework (e.g. \cite{corbett2015}) should allow explicit testing of this idea.
...
\cite{Elyashiv:2010ga} $N_e$ among populations leads to differences in efficiency of purifying selection
