...
This pattern remained after downsampling our maize data to account for differences in sample size. \jri{we should test singleton curve for genes not in 20\% highest H12 also!}   
