...
\significancetext{
Both selection and demographic change play important roles in shaping genetic diversity, but there are few empirical examples of the interplay between these forces. We document the combined effects of demography and linked selection on maize genome-wide diversity. After going through a bottleneck ≈5\% of the size of the ancestral teosinte population, recent expansion resulted in a maize population much larger than teosinte. Positive selection on new genic mutations has affected genetic diversity little, but selection against deleterious mutations dramatically reduced diversity within and surrounding genes. The impact of selection depends on the age of the polymorphisms evaluated, revealing that a complete understanding of genome-wide diversity requires careful assessment of demographic history and the effects of linked selection.
} %JRI
