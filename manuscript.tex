...
Therefore, to estimate the historical demographic parameters of a population, researchers often utilize supposed neutrally-evolving DNA  \cite{luikart2003, gutenkunst2009}. However, it has been called into question whether reasonable approaches exist
...
Soft sweeps are expected to be common when $2N_e\mu_b \ge 1$, where $\mu_b$ is the mutation rate of beneficial alleles with selection coefficient $s_b$ \cite{messer2013population}.  \tmb{Jeff, you put this here, but as written I don't think we need to mention $s_b$}
