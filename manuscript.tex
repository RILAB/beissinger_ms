...
\title{Demographic history and patterns of selection in maize during and since domestication}
...
\begin{abstract}
  Unique selective and demographic forces operate on plants during domestication. These forces interact to generate the patterns of DNA variability that are persistent in crop species today. To quantify this interplay, we investigated genetic diversity in maize, one of the most important crops for food, feed, and fuel world-wide. We utilized whole genome sequence data from 23 maize and 13 teosinte individuals to make inferences.  We obtained a complete estimate of the population size fluctuations and other demographic parameters experienced by maize as it was domesticated from teosinte. Here, we show that maize experienced a domestication bottleneck with a population size of approximately 5\% that of teosinte before it experienced rapid population size expansion post-domestication. We observe that hard sweeps, specifically positive selection on new genic mutations, are not the primary force driving maize evolution. Also, we find that a reduced population size during domestication decreased the efficiency of purifying selection at purging deleterious alleles from maize. However, expansion after domestication has since increased the efficiency of purifying selection to levels superior to those seen in teosinte. Our results demonstrate that in domesticated species, demography and selection are constantly fluctuating through time.
\end{abstract}
...
to more positive values \ref{fig:tajima1989}. This is consistent with the aforementioned purifying
...
The most likely model suggested an ancestral for $\theta$ ($4N\mu$) per base pair of
