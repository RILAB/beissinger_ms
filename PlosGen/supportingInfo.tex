...
%  \end{tabular}
%  \end{center}
  \caption{ {\bf A list of maize and teosinte individuals included in this study.} Sequencing and details were previously described by \cite{chia2012}   } \label{sTab:list}
\end{table}
