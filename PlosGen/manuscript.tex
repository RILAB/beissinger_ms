...
\begin{flushleft}
{\Large
\textbf\newline{Recent demography drives changes in linked selection across the maize genome}
}
\newline
% Insert author names, affiliations and corresponding author email (do not include titles, positions, or degrees).
\\
Timothy M. Beissinger\textsuperscript{1,2,3,*},
Li Wang\textsuperscript{4},
Kate Crosby\textsuperscript{1},
Arun Durvasula\textsuperscript{1},
Matthew B. Hufford\textsuperscript{4},
Jeffrey Ross-Ibarra\textsuperscript{1,5,*},
\\
\bigskip
\bf{1} Department of Plant Sciences, University of California, Davis, Caliornia, USA\\
\bf{2} US Department of Agriculture, Agriculture Research Service, Columbia, Missouri, USA\\
\bf{3} Division of Plant Sciences, University of Missouri, Columbia, Missouri, USA\\
\bf{4} Department of Ecology, Evolution, and Organismal Biology, Iowa State University, Ames, Iowa, USA\\
\bf{5} Genome Center and Center for Population Biology, University of California, Davis, California, USA
\\
\bigskip
...
Both selection and demographic change play important roles in shaping genetic diversity, but there are few empirical examples of the interplay between them. Although it is well known that both diversity and the efficacy of natural selection are reduced in smaller populations, the short-term consequences of demographic change on linked selection have not been well studied. We use wild and domesticated maize to demonstrate that rapid changes in population size impact the effect of selection on linked sites in ways not well described by long-term average population size. We also produce an unbiased estimate of maize demographic history and show that positive selection on new genic mutations plays a lesser role in shaping diversity than purifying selection against deleterious mutations.
...
%\end{center}
\caption{{\bf Diversity and Tajima's D in maize and teosinte.} \textbf{A} and \textbf{B} show mean pairwise diversity $\pi$, $\pm$ one standard deviation, while \textbf{C} and \textbf{D} depict and Tajimas D in 1kb windows from genic and nongenic regions of maize and teosinte.   \label{fig:diversity} }
\end{figure}
...
\caption{{\bf Parameter estimates for a basic bottleneck model of maize domestication.} See methods for details. \label{fig:bottleneck} }
\end{figure}
...
\caption{ {\bf Relative diversity versus distance to nearest gene in maize and teosinte.} 
