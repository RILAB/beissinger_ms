...
\begin{abstract}
  \noindent \bf
  \noindent
Across species, genetic diversity is shaped by the interaction of drift and selection. But the details of this interaction are not well understood. Although a population's propensity to drift is typically summarized by its long-term effective population size ($N_e$ ), rapidly changing population demographics complicate this relationship. To better understand how changing demography impacts selection, we used whole-genome sequencing data to investigate patterns of linked selection in domesticated and wild maize (teosinte). We produce the first unconfounded estimate of $N_e$ at the onset of maize domestication, which shows that maize was reduced to approximately 5\% the population size of teosinte before it experienced rapid expansion post-domestication. As expected, a reduced population size during domestication decreased the efficiency selection, but rapid expansion after domestication has since increased the efficiency of selection to levels exceeding those seen in teosinte. This final observation is applicable to all species that have undergone recent demographic change, including humans, domesticates, model, and non-model species. It demonstrates that rapid demographic change can have immediate and wide-ranging impacts on diversity that conflict with would-be expectations based on $N_e$ alone.
\end{abstract}
